export const env = {
  ...
  firebase: {
    ...
    projectId: import.meta.env.VITE_USE_FIREBASE_EMULATOR === 'true' ? 'humanv1-emulator' : (import.meta.env.VITE_FIREBASE_PROJECT_ID || 'humanv1-emulator'),
  ...
  emulator: {
    authHost: import.meta.env.VITE_FIREBASE_AUTH_EMULATOR_HOST || 'localhost:9098',
    firestoreHost: import.meta.env.VITE_FIREBASE_FIRESTORE_EMULATOR_HOST || 'localhost:8081',
  }
};
